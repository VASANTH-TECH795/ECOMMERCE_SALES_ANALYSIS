...
#10.Groceries - ₹ 47883103.15,  the hights selling by category is Home Decor and lowest is Groceries
...
# maximum count of category is  Book -528 and  Kitchen	528 it shows that books and kitchen category are have maximum orders 
#and mimimum is Beauty products - 460
...
# insight - most of the people prefferd Net Banking mode rather than others
#1.Net Banking-1010
#2.COD(cash on delivery)-1005
#3.Credit Card-994
#4.Debit Card-1003
#5.UPI-988 
# most of the people prefferd Net Banking mode rather than others
